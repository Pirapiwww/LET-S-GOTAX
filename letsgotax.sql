...
VALUES
  (
    ...
    'SuperAdmin',
    'superr@gmail.com',
    '$2y$10$XtzQlnmrVPK0xKvYxRncXuE3RtSaiQx6ik5DJ7/yF3eZALUnPubY.',
    'profileDefault.jpg',
    '2024-12-20 09:53:38'
  );
...
VALUES
  (
    ...
    'unity@gmail.com',
    'UNITY',
    '$2y$10$OpqnJFnbHSb5tkKe0o8aIOTGl6IGeVSjKoR8doEg6vTCVcXk8OO32',
    'profileDefault.jpg',
    'VERIFIED'
  );
...
VALUES
  (
    ...
    1,
    'Unity Lity',
    'Jln. jus apel rasa pisang Blok L no.20',
    'jln. jus pisang rasa apel Blok M no.20',
    '1234123412341234',
    '1734861282_TrySelfieKTP.png',
    '1734861282_TryKTP.png',
    '123456789012',
    'LAKI-LAKI',
    'Sleman, 26 Februari 2000'
  );
...
--
INSERT INTO
  `status_pembayaran` (`id_Status_Pembayaran`, `Nama_Status_Pembayaran`)
VALUES
  ('STP1', 'Pending'),
  ('STP2', 'Processed'),
  ('STP3', 'Completed'),
...
--
ALTER TABLE `akun` ADD PRIMARY KEY (`akunId`),
...
--
ALTER TABLE `databio` ADD PRIMARY KEY (`databioId`),
...
--
ALTER TABLE `kendaraan` ADD PRIMARY KEY (`id_kendaraan`),
...
--
ALTER TABLE `notif` ADD PRIMARY KEY (`notifId`),
...
--
ALTER TABLE `point` ADD PRIMARY KEY (`pointId`),
ADD UNIQUE KEY `akunId` (`akunId`);

--
-- Indexes for table `point_history`
--
ALTER TABLE `point_history` ADD PRIMARY KEY (`historyId`),
ADD KEY `akunId` (`akunId`);

--
-- Indexes for table `status_pembayaran`
--
ALTER TABLE `status_pembayaran` ADD PRIMARY KEY (`id_Status_Pembayaran`);

--
-- Indexes for table `tax`
--
ALTER TABLE `tax` ADD PRIMARY KEY (`taxId`),
ADD KEY `adminId` (`adminId`);

--
-- Indexes for table `vouchers`
--
ALTER TABLE `vouchers` ADD PRIMARY KEY (`voucherId`),
ADD KEY `adminId` (`adminId`);

--
-- Indexes for table `voucher_redemptions`
--
ALTER TABLE `voucher_redemptions` ADD PRIMARY KEY (`redemptionId`),
...
--
ALTER TABLE `akun` MODIFY `akunId` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 9;

--
-- AUTO_INCREMENT for table `contact`
--
ALTER TABLE `contact` MODIFY `contactId` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `databio`
--
ALTER TABLE `databio` MODIFY `databioId` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 7;

--
-- AUTO_INCREMENT for table `kendaraan`
--
ALTER TABLE `kendaraan` MODIFY `id_kendaraan` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 2;

--
-- AUTO_INCREMENT for table `notif`
--
ALTER TABLE `notif` MODIFY `notifId` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `point` MODIFY `pointId` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `point_history`
--
ALTER TABLE `point_history` MODIFY `historyId` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tax`
--
ALTER TABLE `tax` MODIFY `taxId` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 4;

--
-- AUTO_INCREMENT for table `vouchers`
--
ALTER TABLE `vouchers` MODIFY `voucherId` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `voucher_redemptions`
--
ALTER TABLE `voucher_redemptions` MODIFY `redemptionId` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `akun` ADD CONSTRAINT `akun_ibfk_1` FOREIGN KEY (`adminId`) REFERENCES `admin` (`adminId`);

--
-- Constraints for table `databio`
--
ALTER TABLE `databio` ADD CONSTRAINT `databio_ibfk_1` FOREIGN KEY (`akunId`) REFERENCES `akun` (`akunId`),
ADD CONSTRAINT `databio_ibfk_2` FOREIGN KEY (`adminId`) REFERENCES `admin` (`adminId`);

--
-- Constraints for table `kendaraan`
--
ALTER TABLE `kendaraan` ADD CONSTRAINT `kendaraan_ibfk_1` FOREIGN KEY (`akunId`) REFERENCES `akun` (`akunId`),
ADD CONSTRAINT `kendaraan_ibfk_2` FOREIGN KEY (`adminId`) REFERENCES `admin` (`adminId`);

--
-- Constraints for table `point_history`
--
ALTER TABLE `point_history` ADD CONSTRAINT `akunId` FOREIGN KEY (`akunId`) REFERENCES `akun` (`akunId`);

--
-- Constraints for table `tax`
--
ALTER TABLE `tax` ADD CONSTRAINT `tax_ibfk_1` FOREIGN KEY (`adminId`) REFERENCES `admin` (`adminId`);
